...
for i in range(1, m - 1):
    for j in range(i + 1, m):
        r1 = sum_cal(1, 1, n, i) # 왼쪽 직사각형
        r2 = sum_cal(1, i + 1, n, j) # 중간 직사각형
        r3 = sum_cal(1, j + 1, n, m) # 오른쪽 직사각형
        # 작은 직사각형 3개의 각각의 합을 곱한 값이 지금까지 최댓값보다 크다면 최댓값 갱신
        if answer < r1 * r2 * r3:
            answer = r1 * r2 * r3
...
for i in range(1, n - 1):
    for j in range(i + 1, n):
        r1 = sum_cal(1, 1, i, m) # 위쪽 직사각형
        r2 = sum_cal(i + 1, 1, j, m) # 중간 직사각형
        r3 = sum_cal(j + 1, 1, n, m) # 아래쪽 직사각형
        if answer < r1 * r2 * r3:
            answer = r1 * r2 * r3
...
for i in range(1, m):
    for j in range(1, n):
        r1 = sum_cal(1, 1, n, i) # 왼쪽 직사각형
        r2 = sum_cal(1, i + 1, j, m) # 오른쪽 위쪽 직사각형
        r3 = sum_cal(j + 1, i + 1, n, m) # 오른쪽 아래쪽 직사각형
        if answer < r1 * r2 * r3:
            answer = r1 * r2 * r3
...
for i in range(1, n):
    for j in range(1, m):
        r1 = sum_cal(1, 1, i, j) # 왼쪽 위쪽 직사각형
        r2 = sum_cal(i + 1, 1, n, j) # 왼쪽 아래쪽 직사각형
        r3 = sum_cal(1, j + 1, n, m) # 오른쪽 직사각형
        if answer < r1 * r2 * r3:
            answer = r1 * r2 * r3
...
for i in range(1, n):
    for j in range(1, m):
        r1 = sum_cal(1, 1, i, m) # 위쪽 직사각형
        r2 = sum_cal(i + 1, 1, n, j) # 아래쪽 왼쪽 직사각형
        r3 = sum_cal(i + 1, j + 1, n, m) # 아래쪽 오른쪽 직사각형
        if answer < r1 * r2 * r3:
            answer = r1 * r2 * r3
...
for i in range(1, n):
    for j in range(1, m):
        r1 = sum_cal(1, 1, i, j) # 위쪽 왼쪽 직사각형
        r2 = sum_cal(1, j + 1, i, m) # 위쪽 오른쪽 직사각형
        r3 = sum_cal(i + 1, 1, n, m) # 아래쪽 직사각형
        if answer < r1 * r2 * r3:
            answer = r1 * r2 * r3
